...
export default function KIInsightsTrends({
  title = "KI-Insights & Trends",
  description = "Erfahren Sie mehr über aktuelle Entwicklungen in der KI-Transformation und entdecken Sie Best Practices für Ihr Unternehmen.",
  blogPosts = [],
}: KIInsightsTrendsProps) {
