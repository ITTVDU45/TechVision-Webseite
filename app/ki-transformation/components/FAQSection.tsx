...
export default function FAQSection({
  title = "Fragen & Antworten zur KI-Transformation",
  description = "Hier finden Sie Antworten auf die häufigsten Fragen zur KI-Transformation",
  faqs,
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-600">
            {title.includes("KI-Transformation")
              ? title.split("KI-Transformation")[0] + "KI-Transformation" + (title.split("KI-Transformation")[1] || "")
              : title}
          </span>
        </motion.h2>
