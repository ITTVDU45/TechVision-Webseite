...
export default function FAQSection({
  title = "Häufig gestellte Fragen zur Cybersicherheit",
  description = "Finden Sie Antworten auf die wichtigsten Fragen zur Sicherheit Ihres Unternehmens",
  faqs,
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  {faq.icon && <span className="text-2xl">{faq.icon}</span>}
