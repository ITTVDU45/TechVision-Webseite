  ...
  return (
    <div className="space-y-2">
      ...
      <select
        ...
        className="min-h-[44px] w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-2 text-base text-white focus:outline-none focus:ring-2 focus:ring-blue-500 touch-manipulation"
      >
        {pages.map((page) => (
