...
import { AutomationBenefit } from './types';
import { GlowingEffect } from '../../components/ui/glowing-effect';
import Link from 'next/link';

interface AutomationBenefitsSectionProps {
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-white">Automatisierung von </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-red-400 to-orange-500">
              Geschäftsprozessen
            </span>
          </h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Durch den gezielten Einsatz von Automatisierungslösungen können Sie repetitive Aufgaben eliminieren und sich auf strategische Entscheidungen konzentrieren.
          </p>
        </motion.div>
