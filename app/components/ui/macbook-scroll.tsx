...
const Macbook = ({ src }: { src?: string }) => {
  return (
    ...
    >
      <div className="relative mx-auto border-[8px] border-black rounded-[2rem] border-t-[2rem] max-w-[1200px]">
        <div className="absolute left-1/2 top-0 h-2 w-20 -translate-x-1/2 -translate-y-4 rounded-lg bg-black"></div>
        <img
          src={src}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        <div className="absolute inset-0 bg-[#272729] rounded-lg" />
        <img
          src={src || "/images/cms-development.jpg"}
          alt="Macbook screen content"
