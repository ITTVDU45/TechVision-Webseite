      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-8 py-4 bg-gradient-to-r from-teal-500 to-blue-600 rounded-xl text-lg font-medium text-white shadow-xl hover:shadow-2xl hover:shadow-teal-500/20 transition-all"
          >
