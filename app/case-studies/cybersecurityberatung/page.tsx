...
const CybersecurityCasePage: React.FC = () => {
  const caseStudy = categorizedCases.beratung?.find(c => c.id === 'cybersecurityberatung') || {
              ...
              <div className="container mx-auto px-4">
                <div className="max-w-7xl mx-auto">
                  <div className="text-center mb-20">
                    <h2 className="text-5xl font-bold text-white mb-6">Projekt-Ergebnisse</h2>
                    <p className="text-xl text-gray-400 max-w-3xl mx-auto">Konkrete Zahlen und Erfolge, die für sich sprechen</p>
                  </div>
                      ...
                      <div key={index} className="group">
                        <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-white/10 rounded-3xl p-8 transform group-hover:scale-105 group-hover:border-blue-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20">
                          <div className="text-center">
                            <div className="text-7xl font-bold text-transparent bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text mb-4">{stat.value}</div>
          ...
          <section className="py-32 relative">
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-20">
                  <h2 className="text-5xl font-bold text-white mb-6">Über das Projekt</h2>
                  <p className="text-xl text-gray-400 max-w-3xl mx-auto">Detaillierte Einblicke in unsere Lösungsansätze und Technologien</p>
                </div>
                ...
                <div className="prose prose-invert max-w-none">
                  <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm border border-white/10 p-10 rounded-3xl mb-16">
                    <p className="text-2xl text-gray-200 leading-relaxed text-center">{caseStudy.description}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 backdrop-blur-sm border border-cyan-500/30 p-10 rounded-3xl shadow-2xl shadow-cyan-500/10">
                    ...
                    <p className="text-xl text-gray-200 mb-10 leading-relaxed text-center">Umfassende IT-Sicherheitslösungen für kritische Infrastrukturen:</p>
          ...
          <section className="py-16 relative h-[40vh] flex items-center overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
              ...
              >
                ...
                >
                  „Dank der Cybersicherheitsberatung haben wir unsere IT-Sicherheitsmaßnahmen auf ein völlig neues Niveau gehoben. Die praxisnahen Empfehlungen und die strukturierte Vorgehensweise haben geholfen, Schwachstellen gezielt zu identifizieren und zu beheben. – eine Investition, die sich langfristig auszahlt.“
                </motion.blockquote>
                <motion.p
...
export default CybersecurityCasePage;
