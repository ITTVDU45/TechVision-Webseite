...
export default function HeroSection({
  ...
  subtitle = "Wir begleiten Sie durch den gesamten Prozess: von ersten Skizzen und detaillierter Planung bis hin zur Programmierung und nahtlosen Integration.",
      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <AnimatedGradientText>Von der Idee bis zur Integration</AnimatedGradientText>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
