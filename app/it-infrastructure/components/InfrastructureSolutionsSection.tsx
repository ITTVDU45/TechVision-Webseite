...
interface InfrastructureSolutionsSectionProps {
  solutions: InfrastructureSolution[];
}

export default function InfrastructureSolutionsSection({ solutions }: InfrastructureSolutionsSectionProps) {
  return (
