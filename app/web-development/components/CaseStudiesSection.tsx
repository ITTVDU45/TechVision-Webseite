      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
              ...
              <div className="h-full bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-500/10">
                ...
                {caseStudy.link && (
                  <Link href={caseStudy.link}>
                    <button
                      className="reveal w-full px-4 py-2 bg-white/5 hover:bg-white/10 rounded-lg text-sm font-medium text-white border border-white/10 hover:border-white/20 transition-all">
                      Mehr dazu
                    </button>
                  </Link>
                )}
        ...
        <div
          ...
          <Link href="/case-studies">
            <button
              className="reveal px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl text-lg font-medium text-white shadow-xl hover:shadow-2xl hover:shadow-blue-500/20 transition-all">
