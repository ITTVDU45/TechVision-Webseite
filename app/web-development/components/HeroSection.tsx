        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <GlowingEffect>
              <Link
                href="/offer"
                className="px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-600 rounded-xl text-lg font-medium relative overflow-hidden group cursor-pointer block"
              >
                <span className="relative z-10">Webseitenprojekt anfragen</span>
              </Link>
            </GlowingEffect>
          </motion.div>
        </div>
