          ...
          <div>
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-400 mb-8">
                Wir bauen Lösungen mit einem klaren Fokus auf Skalierbarkeit, Sicherheit und
                Performance. Unsere Toolchain kombiniert bewährte Backend- und Frontend-Technologien
                mit modernen KI- und Datenplattformen.
              </p>
            </div>
