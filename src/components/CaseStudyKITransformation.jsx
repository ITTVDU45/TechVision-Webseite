...
const CaseStudyKITransformation = () => {
  return (
            ...
            <div className="container mx-auto px-4 py-16 relative z-10">
              ...
              <div className="max-w-5xl mx-auto text-center">
                ...
                >
                  ...
                  Unternehmensberatung für Vernetzung & Markteintritt (IT & Telekommunikation)
                  </span>
                </motion.h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-neutral-900 p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Komplexe Integration von KI-Diensten",
                    description: "Die Einbindung verschiedener KI-Agenten und externer APIs in eine zusammenhängende Plattform war anspruchsvoll, da ein nahtloser Informationsfluss ohne Medienbrüche sichergestellt werden musste.",
                    icon: <Cross1Icon className="w-5 h-5 text-red-500" />
                  },
                  {
                    title: "Skalierbarkeit der Datenverarbeitung",
                    description: "Das System musste große Mengen an Unternehmensdaten verarbeiten und entsprechend skalieren können, damit die Matching-Datenbank auch bei wachsendem Datenvolumen performant bleibt.",
                    icon: <Cross1Icon className="w-5 h-5 text-red-500" />
                  },
                  {
                    title: "Datenschutz & Compliance",
                    description: "Bei der automatisierten Analyse von Unternehmensinformationen wurde strikt auf Datenschutz geachtet. Die Lösung ist von Anfang an DSGVO-konform konzipiert worden, um alle Compliance-Vorgaben zu erfüllen.",
                    icon: <Cross1Icon className="w-5 h-5 text-red-500" />
                  }
                ].map((item, index) => (
            ...
            <div className="bg-neutral-900 p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                {[
                  {
                    title: "Effizientes Unternehmensmatching",
                    description: "Durch das automatisierte Matching-System konnte der manuelle Recherche- und Analyseaufwand um rund 80 % reduziert werden. Die Mitarbeiter konzentrieren sich nun auf die Pflege der Kundenbeziehungen, während die KI im Hintergrund passende Partner vorschlägt.",
                    icon: <CheckIcon className="w-5 h-5 text-green-500" />
                  },
                  {
                    title: "Echtzeit-Insights",
                    description: "Marktdaten und potenzielle Geschäftsmöglichkeiten werden jetzt in Echtzeit visualisiert. Aktuelle Dashboards bieten einen ständigen Überblick über Trends und mögliche Partnerschaften, was schnellere und datenbasierte Entscheidungen ermöglicht.",
                    icon: <CheckIcon className="w-5 h-5 text-green-500" />
                  },
                  {
                    title: "Mehr Leads & höhere Conversion",
                    description: "KI-gestützte Interaktionen auf der Website (Chatbot-Agent) und personalisierte Inhalte führten zu einer deutlich höheren Zahl qualifizierter Leads. Die Conversion-Rate von Interessenten zu tatsächlichen Projekten bzw. Partnerschaften stieg spürbar an.",
                    icon: <CheckIcon className="w-5 h-5 text-green-500" />
                  }
                ].map((item, index) => (
                  <div key={index} className="bg-neutral-800 p-4 rounded-lg shadow-md flex items-start">
