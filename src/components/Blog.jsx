          ...
          <section className="pt-32 pb-16 relative overflow-hidden flex items-center min-h-screen">
            ...
            <div className="container mx-auto px-4 relative z-10">
              ...
              <div className="max-w-5xl mx-auto text-center">
                ...
                >
                  Coming Soon - Wir arbeiten an unserem Blog!
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <p className="text-gray-300 mb-6">
                    Wir arbeiten an einem umfassenden Blog mit Artikeln zu Technologien, Best Practices und 
                    Erfolgsgeschichten aus der Softwareentwicklung und digitalen Transformation.
                  </p>
          ...
          <section className="py-16 relative">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                >
                  Während wir an unserem Blog arbeiten, stehen wir Ihnen gerne für ein persönliches Gespräch zur Verfügung. 
