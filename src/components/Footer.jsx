      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link 
              href="/"
              className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent inline-block mb-4"
            >
              TechVision
            </Link>
            <p className="text-gray-400 leading-relaxed mb-6">
              Innovation trifft auf Expertise – Wir treiben die digitale Transformation mit KI, IT-Beratung und Cybersecurity-Lösungen voran. Gemeinsam gestalten wir die Zukunft.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <a 
                  href="mailto:info@it-techvision.de" 
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} IT-Techvision. Alle Rechte vorbehalten.
          </p>
          <div className="flex gap-6">
            <Link href="/datenschutz" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
              Datenschutz
            </Link>
            <Link href="/impressum" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
              Impressum
            </Link>
